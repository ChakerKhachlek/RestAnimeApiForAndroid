...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assetsAdmin/css/admin.css')}}">
    <link rel="stylesheet" href="{{asset('assetsAdmin/css/parsley.css')}}">
    @livewireStyles
</head>
<body>
...
<script src="{{asset('assetsAdmin/js/parsley.min.js')}}"></script>
